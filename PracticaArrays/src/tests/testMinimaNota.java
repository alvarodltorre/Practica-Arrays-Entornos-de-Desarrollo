...
class testMinimaNota {
	...
	void testMedia1() {
		...
		double obtenido = misArrays.minimaNota(arrayNotas1);
		double esperado = 1;
	...
	void testMedia2() {
		...
		double obtenido = misArrays.minimaNota(arrayNotas2);
		double esperado = 3;
	...
	@Test
	void testMedia3() {
		Exception e = assertThrows(IllegalArgumentException.class, () -> misArrays.minimaNota(arrayNotas3));
